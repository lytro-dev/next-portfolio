...
const MapComponent = ({ visitors, height }: { visitors: MapVisitor[]; height: number }) => {
...
export default function VisitorMap({ visitors, title = "Visitor Locations", height = 400, className = "" }: VisitorMapProps) {
    ...
    // Generate mock coordinates for visitors (in real app, you'd have actual lat/lng)
    const mapVisitors = useMemo(() => {
        return filteredVisitors.map((visitor, index) => {
            // Generate mock coordinates based on country (in real app, use actual geocoding)
            ...
            const coords = countryCoords[visitor.country] || { lat: 0, lng: 0 };
    ...
    return (
        <div className={`bg-white rounded-xl shadow-sm border border-gray-200 ${className}`}>
            ...
            <div className="p-4 sm:p-6">
                ...
                >
                    {isClient ? (
                        <MapComponent visitors={mapVisitors} height={height} />
                    ) : (
                        <div className="flex items-center justify-center h-full bg-gray-50">
                            <div className="text-center">
                                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-auto mb-2"></div>
